/* Shared design tokens + primitives for the 3 dashboard concepts.
   Mirrors the Dun Rite Project Controls visual vocabulary. */
...
const Kpi = ({icon, label, value, sub, delta, deltaKind='up', tint}) => {
  ...
  return (
    <div style={{background:DRtok.card,border:`1px solid ${DRtok.line}`,borderRadius:16,padding:'16px 16px 14px',boxShadow:'0 1px 2px rgba(20,33,48,.04)'}}>
